...
export function useUsuariosActions() {
  ...
  const getMappedRolePermissions = async id_rol =>
    dispatch(get_mapped_role_permissions({ id_rol }))
  ...
  const getCreateUsuarioParametros = async () =>
    dispatch(get_usuarios_parametros())
