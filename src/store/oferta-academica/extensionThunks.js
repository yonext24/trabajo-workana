...
export const get_extension_data = createAsyncThunk('oferta-academica/extension/get', async (_, api) => {
  ...
  return fakeData({ ua: 2, codigo: 2, nombre: 7, abreviatura: 5, estado: 1, fecha_de_creacion: '28/8/23' })
})
...
export const setExtensionThunks = (builder) => {
  setThunks({ builder, noLoopData, hasFiltered: true, placeName: 'carrera' })
}
