...
export const get_extension_data = createAsyncThunk(
  'oferta-academica/extension/get',
  async (_, api) => {
...
export const add_extension = createAsyncThunk(
  'oferta-academica/extension/add',
...
export const update_extension = createAsyncThunk(
  'oferta-academica/extension/update',
  async (_, api) => {
    await new Promise(resolve => setTimeout(resolve, 2000))
...
export const delete_extension = createAsyncThunk(
  'oferta-academica/extension/delete',
  async ({ nombre }, api) => {
    await new Promise(resolve => setTimeout(resolve, 2000))
