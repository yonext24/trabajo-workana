...
import { ChangeRoleButton, DeactivateButton, UpdateButton } from '@/components/common/table-buttons'
...
export function Usuarios () {
  ...
  const { handleAdd, handleUpd, handleDel } = useTableDefaultModals({
    ...
    del: { onClick: () => { toast('Aún no funciona, esperando que me entreguen api.') }, title: 'Desactivar usuario', sure: 'Realmente quieres desactivar este usuario?' }
  })
  ...
  return <div id='page-content'>
...

    {
      ...
      <div className='w-full flex gap-3 justify-center'>
        <UpdateButton handleClick={handleUpd} iconProps={{ className: '!h-10 !w-10' }} />
        <ChangeRoleButton handleClick={handleRole} iconProps={{ className: 'h-10 w-10' }} />
        <DeactivateButton handleClick={handleDel} iconProps={{ className: 'h-10 w-10' }} />
      </div>
    }
  </div>
}
