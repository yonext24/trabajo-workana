    ...
    <form className='p-6 w-full flex gap-4 flex-col [&_label]:text-lg [&_label]:font-semibold'>
      ...
      <div className='flex [&>*]:flex-1 gap-3'>
        <div className='flex flex-col'>
          ...
          <SelectInputControlled id='nivel' name='nivel' options={['Técnico', 'Inicial']} firstOne control={control} />
        </div>
        <div className='flex flex-col'>
          <label>Carrera</label>
          <SelectInputControlled id='carrera' name='carrera' options={['Enfermería profesional', 'Profesor de Geografía']} firstOne control={control} />
        </div>
      </div>
      <div className='flex [&>*]:flex-1 gap-3'>

        <InputWLabel type='date' labelText='Fecha de creación' name='fecha_de_creacion' defaultValue={new Date().toISOString().split('T')[0]} />
