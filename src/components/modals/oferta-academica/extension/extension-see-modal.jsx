...
export function ExtensionSeeModal ({ closeModal, ua, codigo, nombre, estado, fecha_de_creacion, abreviatura, ubicacion }) {
    ...
    <DefaultModalLayout className='!max-w-3xl' title='Ver Extensión' closeModal={closeModal}>
      <div className="p-6 flex flex-col">
        ...
        <div className='flex gap-4 lg:gap-4 w-full justify-between [&>input]:w-full'>
          ...
          <InputWLabel id='fecha_de_creacion' name='fecha_de_creacion' labelText='Fecha de creación' disabled defaultValue={fecha_de_creacion} />
