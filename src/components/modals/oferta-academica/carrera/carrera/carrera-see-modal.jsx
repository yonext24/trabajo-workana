  ...
  return <ModalBackground closeModal={closeModal} onClick={closeModal}>
    <DefaultModalLayout title='Ver Carrera' className='!max-w-3xl' closeModal={closeModal}>
      <div className='p-6 flex flex-col gap-4'>
        ...
        <InputWLabel name='titulo_femenino' disabled defaultValue={titulo_femenino} labelText='Título femenino' required />
        <InputWLabel name='titulo_masculino' disabled defaultValue={titulo_masculino} labelText='Título masculino' required />
        ...
        <div className='flex'>
          ...
          <div className='flex-1 flex gap-3 [&>*]:flex-1'>
            <InputWLabel disabled name='fecha_de_creacion' labelText='Fecha de creación' type='date' defaultValue={new Date().toISOString().split('T')[0]} required />
            <div className='flex flex-col'>
              <label disabled className='font-semibold text-lg'>Estado</label>
